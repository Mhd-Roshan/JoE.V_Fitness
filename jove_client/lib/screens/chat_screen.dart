...
class _ChatScreenState extends State<ChatScreen>
  ...
  Stream<QuerySnapshot>? _messagesStream100;
  final Map<String, Future<Map<String, dynamic>>> _dietPlanCache = {};
  ...
  void initState() {
    ...
    _checkSubscription();
    if (currentUser != null) {
      _messagesStream50 = FirebaseFirestore.instance
      ...
      _messagesStream100 = FirebaseFirestore.instance
          .collection('chatThreads')
          .doc(currentUser!.uid)
          .collection('messages')
          .orderBy('createdAt', descending: true)
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<Map<String, dynamic>>(
                  future: _dietPlanCache.putIfAbsent(templateId, () => _fetchDietPlanData(templateId)),
  ...
  Widget _buildFallbackImage() {
    ...
    return Container(
      height: 180,
      width: double.infinity,
      color: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFF4F5F7),
      child: Center(
        child: Icon(
          Icons.restaurant,
          color: isDark ? const Color(0xFF555555) : Colors.grey.shade400,
          size: 48,
        ),
      ),
    );
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w900,
              color: isDark ? const Color(0xFF60A5FA) : const Color(0xFF00215F),
            ),
          ),
        ],
      ),
  ...
  Widget _buildTextBubble(Map<String, dynamic> data) {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isMe
              ? (isDark ? const Color(0xFF003AA3) : _userBubbleColor)
              : (isDark ? const Color(0xFF1E1E1E) : _adminBubbleColor),
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                color: isMe
                    ? Colors.white
                    : (isDark ? const Color(0xFFF5F5F5) : _textMain),
                fontSize: 15,
  ...
  Widget _buildMessageInput() {
    ...
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF000000) : _bgColor,
      ),
      child: Row(
        children: [
          GestureDetector(
  ...
  Widget _buildBottomNavBar() {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isDark ? const Color(0xFF121212) : _navBgColor,
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
                    ...
                    Expanded(
                      child: currentUser == null
                          ...
                          : StreamBuilder<QuerySnapshot>(
                              stream: _messagesStream100,
                              builder: (context, snapshot) {
                                if (snapshot.hasError) {
                                  return Center(
                                    child: Text(
                                      '${"error_loading_chat".tr()}: ${snapshot.error}',
                                      style: TextStyle(
                                        color: isDark
                                            ? const Color(0xFFA8A8A8)
                                            : Colors.black,
              ...
              if (!isKeyboardOpen && widget.showBottomNav) _buildBottomNavBar(),
            ],
          ),
        );
      },
